<template>
    <section class="flowoa-design" ref="flowoaDesignRef">
        <div class="zoom">
...
import { nodeTypeList } from '@/utils/flowoa/const'
...
import { wheelZoomFunc, zoomInit, resetImage } from "@/utils/flowoa/zoom.js";
import { flattenMapTreeToList } from '@/utils/flowoa/nodeUtils'
...
const flowoaDesignRef = ref(null);
...
onMounted(async () => {
    zoomInit(flowoaDesignRef, boxScaleRef, (val) => {
        nowVal.value = val
    });
...
@use "@/assets/styles/flowoa/workflow.scss";
</style>